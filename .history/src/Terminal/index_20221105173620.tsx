...
import { useDynamicList, useEventListener, useKeyPress, useLatest } from 'ahooks';
...
function Terminal() {
  ...
  const writeComponentOutput:JTerminal.TerminalType['writeComponentOutput'] = (component:any)=>{
    writeOutput({
      type:'component',
      component,
    })
